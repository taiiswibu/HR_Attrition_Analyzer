...
# Display constants (scaled for visualization)
DISPLAY_WIDTH = 1200
DISPLAY_HEIGHT = 960
SCALE_FACTOR = DISPLAY_WIDTH / GRID_WIDTH  # For rendering on screen
...
# Zone colors
COLOR_SERENGETI = (139, 69, 19)  # Brown
COLOR_MARA_RIVER = (30, 144, 255)  # Blue
COLOR_MASAI_MARA = (34, 139, 34)  # Green
...
if __name__ == "__main__":
    ...
    from wildebeest_migration_core import test_simulation
    test_simulation()